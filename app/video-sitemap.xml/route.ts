...
const videos = [
  {
    src: "/esp32-demo.mp4",
    title: "ESP32 Demo",
    description: "A demonstration of the ESP32 project.",
  },
  {
    src: "/mobile-compressed.mp4",
    title: "Mobile App Demo",
    description: "Mobile application usage demonstration.",
  },
  {
    src: "/ble_speaker_final.mp4",
    title: "BLE Speaker Final",
    description: "Final version of the custom BLE Speaker.",
  },
  {
    src: "/arch_ricing.mp4",
    title: "Arch Linux Ricing",
    description: "Customizing and ricing Arch Linux.",
  },
  {
    src: "/playing_tts.mp4",
    title: "Playing TTS",
  ...
  },
  {
    ...
    title: "BLE Speaker Mono",
    description: "Mono version of the BLE Speaker.",
  },
];
